...
const updatePaths = () => {
	...
	const newIndexData = indexData.replace(/static/g, 'core/static').replace(/favion/g, 'core/favicon')
	...
	const mainPath = resolvePath(`build-ext/core/${manifestData.files['main.js']}`)
